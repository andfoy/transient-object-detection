...
cfg = {
    ...
    'F': [64, 'U', 128, 128, 'U', 256, 256, 256, 'U', 512, 512, 512,
          'U', 512, 512, 512, 'U'][::-1]
}
...
class SegNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # x1p, id1 = F.max_pool2d(x12, kernel_size=2,
        #                         stride=2, return_indices=True)

        # # Stage 2
        # x21 = F.relu(self.bn21(self.conv21(x1p)))
        # x22 = F.relu(self.bn22(self.conv22(x21)))
        # x2p, id2 = F.max_pool2d(x22, kernel_size=2,
        #                         stride=2, return_indices=True)
        ...
        # x3p, id3 = F.max_pool2d(x33, kernel_size=2,
        #                         stride=2, return_indices=True)
        ...
        # x4p, id4 = F.max_pool2d(x43, kernel_size=2,
        #                         stride=2, return_indices=True)
        ...
        # x5p, id5 = F.max_pool2d(x53, kernel_size=2,
        #                         stride=2, return_indices=True)
